...
/// Foundation tab screen for the dashboard bottom navigation
class FoundationTabScreen extends StatefulWidget {
  const FoundationTabScreen({super.key});

  @override
  State<FoundationTabScreen> createState() => _FoundationTabScreenState();
}

class _FoundationTabScreenState extends State<FoundationTabScreen> {
  @override
  void initState() {
    super.initState();
