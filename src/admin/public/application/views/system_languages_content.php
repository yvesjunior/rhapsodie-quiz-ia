...
<head>
    ...
    <title><?= lang('system_languages') ?></title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="<?= base_url() ?>system-languages/content?iframe=1" class="needs-validation" novalidate="" enctype="multipart/form-data">
