...
// 
// Mac Development:
// - iOS Simulator: use 'http://localhost:8080' (works on Mac)
// - Physical iOS device: use your Mac's IP address (currently: http://10.0.0.39:8080)
// - Android Emulator: use 'http://10.0.2.2:8080' (special Android emulator IP)
// - Physical Android device: use your Mac's IP address (currently: http://10.0.0.39:8080)
