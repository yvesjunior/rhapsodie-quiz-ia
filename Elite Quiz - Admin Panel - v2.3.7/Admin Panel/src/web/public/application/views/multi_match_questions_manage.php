                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="toolbar">
                                            <?php if (has_permissions('delete', 'multi_match')) { ?>
    ...
    <script type="text/javascript">
        $(document).on('click', '.delete-data', function() {
            if (confirm("<?= lang('sure_to_delete_questions_releated_data_deleted'); ?>")) {
                ...
                $.ajax({
                    url: base_url + 'delete_multi_match',
                    type: "POST",
